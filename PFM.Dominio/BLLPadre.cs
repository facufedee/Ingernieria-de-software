...
namespace BLL
{
    public class BLLPadre:BLLPermiso
    {
        ...
        DalAccesoDatos acesoDatos;
        public BEPermiso GuardarPermiso(BEPermiso permiso)
        {

            acesoDatos = new DalAccesoDatos();
            return acesoDatos.GuardarPermiso(permiso, true);
        }
        ...
        public IList<BEPadre> ObtenerMenus()
        {
           acesoDatos = new DalAccesoDatos();
            ...
            return acesoDatos.ObtenerMenus();
        }
        public IList<BEPermiso> ObtenerArbolMenu(BEPadre padre)
        {
            acesoDatos = new DalAccesoDatos();

            return acesoDatos.ObtenerArbolMenu(padre);
        }
        public void SeleccionarMenu(BEPadre padre)
        {
            acesoDatos = new DalAccesoDatos();

            acesoDatos.SeleccionarPadre(padre);
        }
...

        {
            ...
            acesoDatos.ActualizarPErmisos(menuPadre, relacionesEliminadasLista, relacionesAgregadasLista, relacionesPatentesEliminadas);
...

        {
            ...
            acesoDatos.ActualizarPErmisosUsuario(usuario, relacionesEliminadasLista, relacionesAgregadasLista);
